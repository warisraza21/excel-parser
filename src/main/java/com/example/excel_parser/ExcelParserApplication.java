...
import com.example.excel_parser.service.WorkbookInfoBuilderV2;
...
public class ExcelParserApplication {
	...
	public static void main(String[] args) throws JsonProcessingException {
		...
		log.info("WorkBookInfo : {}", objectMapper.writeValueAsString(WorkbookInfoBuilderV2.buildWorkbookInfo(filePath)));
	}
}
